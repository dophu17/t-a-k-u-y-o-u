...
<div id="products" class="contents-main">
    ...
    <table class="form">
        ...
        <tr>
            <th>ワードプレスの投稿ID</th>
            <td>
                <span class="attention"><!--{$arrErr.wp_post_id}--></span>
                <input type="text" name="wp_post_id" value="<!--{$arrForm.wp_post_id|h}-->" maxlength="" size="" class="box6" style="<!--{$arrErr.wp_post_id|sfGetErrorColor}-->" />
                <!--{* <span class="attention"> (上限<!--{$smarty.const.URL_LEN}-->文字)</span> *}-->
                <span class="attention"> (ヌルの場合はランダム)</span>
            </td>
        </tr>
        <tr>
