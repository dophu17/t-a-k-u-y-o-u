        ...
        <div id="detailarea" class="clearfix">
            ...
            <div id="detailrightbloc">
                ...
                <div class="main_comment">
                    ...
                    <table class="post-wp">
                    <!--{foreach from=$arrProduct.wp_posts item=item}-->
                        <tr>
                            <td class="td-thumb">
                                <!--{if $item.thumb.guid}-->
                                    <img src="<!--{$item.thumb.guid}-->">
                                <!--{else}-->
                                    <img src="<!--{$url_noimage}-->">
                                <!--{/if}-->
                            </td>
                            <td class="no-padding">
                                ...
                                <div>
                                    <!--{if $item.post_content|mb_strlen > 200}-->
                                        <!--{$item.post_content|strip_tags|mb_substr:0:200}-->...
                                    <!--{else}-->
                                        <!--{$item.post_content|strip_tags}-->
                                    <!--{/if}-->
                                    <a target="_blank" href="<!--{$item.guid}-->">詳細</a> 
                                </div>
                            </td>
                        </tr>
                    <!--{/foreach}-->
