...
<div id="undercolumn">
    ...
    <!--{foreach from=$arrProducts item=arrProduct name=arrProducts}-->
        ...
        <!--{assign var=wordpressPost value=$arrProduct.wordpress_post}-->
        <!--▼商品-->
        <form name="product_form<!--{$id|h}-->" action="?">
            ...
            <div class="list_area clearfix">
                ...
                <div class="listphoto">
                    <!--★画像★-->
                    <!--{ assign var='noImageUrl' value=$smarty.const.IMAGE_SAVE_URLPATH|cat:''|sfNoImageMainList }-->
                    <!--{strip}-->
                    <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->">
                        <img src="
                            <!--{if $wordpressPost.images.thumbnail.link|strlen >= 1 }-->
                                <!--{ $wordpressPost.images.thumbnail.link |h }-->
                            <!--{elseif $arrProduct.main_image}-->
                                <!--{$arrProduct.url_main_image}-->
                            <!--{else}-->
                                <!--{ $noImageUrl|h }-->
                            <!--{/if}-->
                            " alt="<!--{$arrProduct.name|h}-->" class="picture" /></a>
                    <!--{/strip}-->
                </div>
                ...
                <div class="listrightbloc">
                    ...
                    <!--★商品名★-->
                    <h3>
                        <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->"><!--{$arrProduct.wordpress_post.title.rendered|h}--></a>
                    </h3>
                    <!--★価格★-->
                    ...
                    <div class="wp_post_content"><!--{$arrProduct.wordpress_post.content.rendered|nl2br}--></div>
